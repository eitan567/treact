...
const RightColumn = styled.div`
  ...
  ${tw`bg-green-500 bg-cover bg-center xl:mr-24 h-96 lg:h-auto lg:w-1/2 lg:flex-1`}
`;
...
const Actions = styled.div`
  ...
  .secondaryAction {
    ${tw`mt-4 sm:mt-0 sm:mr-4 bg-gray-300 text-gray-700 hover:bg-gray-400 hover:text-gray-800`}
  }
`;
