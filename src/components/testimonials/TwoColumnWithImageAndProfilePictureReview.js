...
const ControlContainer = tw.div`absolute bottom-0 left-0 bg-gray-100 px-6 py-4 rounded-tl-3xl border`;
...
const HeadingTitle = tw(SectionHeading)`lg:text-right leading-tight`;
const Description = tw.p`max-w-md text-center mx-auto lg:mx-0 lg:text-right lg:max-w-none leading-relaxed text-sm sm:text-base lg:text-lg font-medium mt-4 text-secondary-100`;

const QuoteContainer = tw.div`relative mt-10 lg:mt-20`;
const Quote = tw.blockquote`text-center lg:text-right text-sm sm:text-lg lg:text-xl xl:text-2xl`;
const CustomerInfo = tw.div`mt-6 flex flex-col sm:flex-row items-center justify-center lg:justify-start`;
const CustomerProfilePicture = tw.img`rounded-full w-20 h-20`;
const CustomerTextInfo = tw.div`text-center lg:text-right sm:ml-6 mt-2 sm:mt-0`;
