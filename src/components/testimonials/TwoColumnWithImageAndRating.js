...
const TextColumn = styled(Column)(props => [
  ...
  props.textOnLeft ? tw`md:pl-12 lg:pl-16 md:order-first` : tw`md:pr-12 lg:pr-16 md:order-last`
]);
...
const Heading = tw(
  SectionHeading
)`mt-4 font-black text-right text-3xl sm:text-4xl lg:text-5xl text-center md:text-right leading-tight`;
const Description = tw.p`mt-6 text-center md:text-right text-sm md:text-base lg:text-lg font-medium leading-relaxed text-secondary-100`;

const TestimonialSlider = styled(Slider)`
  ${tw`w-full mt-10 text-center md:text-right`}
  .slick-track {
    ${tw`flex`}
  }
  .slick-slide {
...
const CustomerTextInfo = tw.div`text-center md:text-right sm:ml-6 mt-2 sm:mt-0`;
