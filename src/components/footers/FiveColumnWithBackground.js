...
const FiveColumns = tw.div`flex flex-wrap text-center sm:text-right justify-center sm:justify-start md:justify-between -mt-12`;
...
const LogoText = tw.h5`mr-2 text-xl font-black tracking-wider text-gray-100`;

const CopywrightNotice = tw.p`text-center text-sm sm:text-base mt-8 md:mt-0 font-medium text-gray-400`;

const SocialLinksContainer = tw.div`mt-8 md:mt-0 flex`;
const SocialLink = styled.a`
  ${tw`cursor-pointer p-2 rounded-full bg-gray-100 text-gray-900 hover:bg-gray-400 transition duration-300 ml-4 last:mr-0`}
  svg {
    ${tw`w-4 h-4`}
  }
`;
