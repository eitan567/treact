...
const Statistics = tw.div`flex flex-col items-center sm:block text-center md:text-right mt-4`;
const Statistic = tw.div`text-right sm:inline-block sm:ml-12 last:ml-0 mt-4`;
