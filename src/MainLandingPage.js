...
const Description = tw(
  DescriptionBase
)`mt-4 text-center lg:text-right lg:text-base text-gray-700 max-w-lg mx-auto lg:mx-0`;
...
const SecondaryButton = tw(
  ActionButton
)`mt-6 sm:mt-12 sm:mr-8 bg-gray-300 text-gray-800 hocus:bg-gray-400 hocus:text-gray-900`;
...
const FeatureText = tw.p`mr-2 font-medium text-gray-700`;
          ...
          <Component key={componentIndex}>
            <ComponentHeading>
              ...
              <ComponentPreviewLink className="group" href={component.url} target="_blank">
                View Live Demo{" "}
                <ArrowRightIcon tw="transition duration-300 transform group-hover:translate-x-px mr-2 w-4 h-4" />
